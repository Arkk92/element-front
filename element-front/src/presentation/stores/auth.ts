import { onUserAuthDataUpdated } from "@/infra/sockets/services/auth/userAuthDataSocket";
import { UserAuthData } from "@/infra/sockets/socketUtils";
...
export const useAuthStore = defineStore("auth", {
  ...
  actions: {
    ...
    listenForAuthUpdates() {
      onUserAuthDataUpdated(this.updateAuthData);
    },
  },
});
